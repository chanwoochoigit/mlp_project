...
def save_plot(examples, epoch, n=7):
    ...
    # save plot to file
    filename = 'generated_images/temp/generated_plot_e%03d.png' % (epoch + 1)
...
def summarize_performance(epoch, generator, discriminator, dataset, latent_dim, n_samples=150):
    ...
    filename = 'models/temp/generator_model_%03d.h5' % (epoch + 1)
    generator.save(filename)


# train the generator and discriminator
def train(generator, discriminator, gan_model, dataset, latent_dim, n_epochs=3000, n_batch=128):
...
if __name__ == '__main__':
    ...
    # load image data
    chair_data = np.load('mixed_data/chair_bee_cloud.npy')
    dataset = format_data(chair_data)
    # train model
